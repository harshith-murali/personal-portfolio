...
export function SocialIcon({ platform, url, className = '' }: SocialIconProps) {
  ...
  return (
    <motion.a
      ...
      className="inline-flex items-center justify-center p-2 rounded-lg text-accent-primary light:text-amber-700 hover:text-accent-secondary light:hover:text-amber-600 hover:bg-dark-800 light:hover:bg-gray-200 transition-colors"
