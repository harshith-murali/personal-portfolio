...
export const skills: Skill[] = [
  ...
  {
    category: "Auth & Tools",
    items: ["Clerk", "Git", "GitHub", "Vercel"],
  },
  {
    category: "Cloud & DevOps",
    items: ["Vercel", "AWS (EC2, S3, Lambda, IAM)", "MongoDB Atlas"],
  },
];
...
export const projects: Project[] = [
  {
    ...
    title: "UrbanTwins",
    description:
      "Smart City Digital Twin Dashboard - Real-time simulation of traffic, energy, water, and disaster infrastructure across Bengaluru with AI-powered recommendations",
  ...
  },
  {
    ...
    title: "Sniply",
    description:
      "URL Shortener with Advanced Analytics - Custom aliases, click tracking, and detailed analytics including browser, OS, device, and referrer breakdowns",
  ...
  },
  {
    ...
    title: "OpenVerse",
    description:
      "Full-Stack Blog Platform - Complete CRUD functionality with Clerk authentication, MongoDB Atlas database, and a sleek Next.js frontend for seamless content creation and management",
  ...
  },
  {
    ...
    title: "Auth System",
    description:
      "Complete Authentication Flow - Sign-up, sign-in, logout, forgot password, OTP verification, and JWT-based session management",
...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    type: "work",
    description: [
      "Coordinating technical events and student activities",
  ...
  },
  {
    ...
    type: "achievement",
    description: [
      "Led 24-hour global codeathon",
      "Collaboration with GeeksforGeeks",
    ],
  },
];
...
export const achievements: Achievement[] = [
  {
    ...
    description:
      "Demonstrates foundational expertise in AWS cloud architecture, core services, security, and billing models",
    icon: "☁️",
    date: "2026",
    link: "http://credly.com/badges/4f7fd64b-9ca4-4ab6-95c3-d27a8402cb1a",
  },
  {
    id: "2",
    title: "1st Place - CODEVERSE 24hr Hackathon",
    description:
      "Secured 1st place at CODEVERSE 24-hour hackathon (IEEE Computer Society, BMSCE), competing among college-wide participants",
    icon: "🏆",
    date: "2026",
...

  {
    ...
    title: "LeetCode",
    description:
      "150+ problems solved with focus on system design and algorithms",
    icon: "💻",
    date: "Ongoing",
